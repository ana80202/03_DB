...
--ORA-12899: "KH_CDY"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
SELECT * FROM DEPT_COPY;
--ORA-00942: 테이블 또는 뷰가 존재하지 않습니다 -> 삭제가 잘 되었다!
...
--DEPT_COPY 테이블에 PK추가 (컬럼 : DEPT _ID,제약조건명 : D_COPY_PK)
...
--2) 제약조건명 변경 (D.COPY_PK -> DEPT_COPY_PK)
...
SELECT * FROM TB2; --FK 제약이 걸려있는게 아니라 단순히 숫자로만 남아있는 것임
