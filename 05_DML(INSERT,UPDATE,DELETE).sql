...
--1) INSERT INTO 테이블명 VALUES(데이터, 데이터, 데이터, ...) EX) 'D9','총무부','L1'
--테이블에 있는 모든 컬럼에 대한 값을 INSERT 할 떄 사용
--INSERT 하고자 하는 컬럼이 모든 컬럼인 경우 컬럼명 생략 가능
--단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야 함

INSERT INTO EMPLOYEE2
VALUES('900','개구리','980123-1234451','frog_g@naver.com',
...
VALUES('900','개구리','980123-1234451','frog_g@naver.com','01012341234',
			'D1','J7','S3',4300000);
...
--서브쿼리(SELECT) 결과물 EMP_01 테이블 INSERT
...
INSERT INTO EMP_M02
VALUES(999,'곽두원','870302-1234567','kwack_dw@kh.or.kr',
...
INSERT VALUES(EMP_M02.EMP_ID, EMP_M02.EMP_NAME, EMP_M02.EMP_NO, EMP_M02.EMAIL, 
	         EMP_M02.PHONE, EMP_M02.DEPT_CODE, EMP_M02.JOB_CODE, EMP_M02.SAL_LEVEL,EMP_M02.SALARY, EMP_M02.BONUS,
...
--삭제확인
SELECT * FROM EMPLOYEE2
WHERE EMP_NAME = '개구리'; --> 조회 결과 없음

ROLLBACK; -- 마지막 커밋 시점까지 돌아감

--롤백 확인
SELECT * FROM EMPLOYEE2
WHERE EMP_NAME = '개구리'; --> 조회 결과 있음
