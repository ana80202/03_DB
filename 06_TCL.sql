...
/*TRANSACTION 이란? (바구니생각하기)
 * - 데이터베이스의 논리적 연산 단위
 * - 데이터의 변경 사항을 묶어서 하나의 트랜잭션에 담아 처리하는 것
 ...
 * SAVEPOINT "포인트명2";
 * ...
 * ROLLBACK TO "포인트명1"; --포인트1 지점까지 데이터 변경 사항 삭제
 * 
...
COMMIT; -->DB에 실제로 반영이 됨

ROLLBACK; --> 트랜잭션이 이미 비워진 상태고 DB에 저장된 상태임
