...
CREATE USER spring_cdy IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_cdy;

ALTER USER spring_cdy DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
UPDATE "MEMBER" SET
MEMBER_PW =  '$2a$10$sTGFdtV8ict5Ig4AmYqQAurAjQ7VDKqqjPjeWEYMT8gbRbydjdlfS'
WHERE MEMBER_NO = 1;
